...
abstract public class ArticlePageObject extends MainPageObject {
    ...
    @Step("Waiting for Article on Page")
    ...
    @Step("Add article to  My List for Android")
    ...
    @Step("Add article to  My List for iOS and Mobile-Web")
    ...
    @Step("Remove Article if it has been added")
    ...
    @Step("Close Sync Your Saved Article pop up")
